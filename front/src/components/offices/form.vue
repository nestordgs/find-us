  ...
  <v-form>
    <v-stepper v-model="stepper">
      ...
      <v-stepper-content step="1">
        ...
        <v-layout row wrap>
          <v-flex xs12 sm6>
            ...
            <v-select :items="locations" v-model="data.id_ubicacion" label="Seleccione un Estado" single-line item-text="ubicacion" item-value="id_ubicacion" prepend-icon="fa-location-arrow" required></v-select>
          </v-flex>
          <v-flex xs12 sm6>
      ...
      <v-stepper-content step="2">
        ...
        <v-btn primary @click.native="stepper = 3">Continue</v-btn>
        <v-btn flat @click.native="stepper = 1">Cancel</v-btn>
      </v-stepper-content>
      <v-stepper-content step="3">
        <v-layout row wrap>
          <v-flex xs6 sm4 md3>
            <v-switch label="Feriado Bancario" v-model="data.feriado_bancario" color="success" :input-value="data.feriado_bancario" hide-details></v-switch>
          </v-flex>
          <v-flex xs6 sm4 md3>
            <v-switch label="Carnaval" color="success" v-model="data.carnaval" :input-value="data.carnaval" hide-details></v-switch>
          </v-flex>
          <v-flex xs6 sm4 md3>
            <v-switch label="Semana Santa" color="success" v-model="data.semana_santa" :input-value="data.semana_santa" hide-details></v-switch>
          </v-flex>
          <v-flex xs6 sm4 md3>
            <v-switch label="Impuesto" color="success" v-model="data.impuesto" :input-value="data.impuesto" hide-details></v-switch>
          </v-flex>
          <v-flex xs6 sm4 md3>
            <v-switch label="Abramatic" color="success" v-model="data.abramatic" :input-value="data.abramatic" hide-details></v-switch>
          </v-flex>
          <v-flex xs6 sm4 md3>
            <v-switch label="Externa" color="success" v-model="data.externa" :input-value="data.externa" hide-details></v-switch>
          </v-flex>
          <v-flex xs6 sm4 md3>
        ...
        <v-layout row justify-space-between>
          <v-flex xs3>
            <v-text-field type="number" label="N° de Cajeros en la Oficina" name="atm_ofic" v-model="data.atm_ofic" required></v-text-field>
          </v-flex>
          <v-flex xs3>
            <v-text-field type="number" label="N° de Cajeros de la Ubicacion" name="atm_ubic" v-model="data.atm_ubic" required></v-text-field>
          </v-flex>
          <v-flex xs3>
            <v-text-field type="number" label="N° de Cajeros Multifuncionales en la Oficina" name="multifuncionales_ofic" v-model="data.multifuncionales_ofic" required></v-text-field>
          </v-flex>
        </v-layout>
