    ...
    <vue-good-table :columns="columns"
      ...
      <template slot="table-row" scope="props">
        ...
        <td class="text-center">
          <dialog-info :data="location" :properties="dialogPropertiesState"
                       @execute="getLocation(props.row.id_ubicacion)"></dialog-info>
        </td>
        <td class="text-center">
          <dialog-info :data="city" :properties="dialogPropertiesCity"
                       @execute="getCity(props.row.id_ciudad)"></dialog-info>
        </td>
        <td>
